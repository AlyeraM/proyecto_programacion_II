...
(function(factory) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      removeSelectedLabel: 'Eliminar Seleccion',
      ...
      infoTextFiltered: '<span class="badge badge-warning">Filtrando</span> {0} de {1}', // when not all of the options are visible due to the filter
